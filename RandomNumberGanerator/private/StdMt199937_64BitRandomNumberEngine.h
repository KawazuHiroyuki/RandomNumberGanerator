...
class StdMt199937_64BitRandomNumberEngine : public RandomNumberEngine<T1, T2>
{
...
public:
     ...
     * \param seed シード生成器
     */
    StdMt199937_64BitRandomNumberEngine(std::shared_ptr<RandomNumberEngineParameter<ResultType, EngineResultType>> param, std::shared_ptr<SeedGenerator<Seed>> seed)
