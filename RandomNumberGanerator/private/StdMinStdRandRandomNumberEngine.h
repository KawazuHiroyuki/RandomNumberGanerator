...
class StdMinStdRandRandomNumberEngine : public RandomNumberEngine<T1, T2>
{
...
public:
     ...
     * \param seed シード生成器
     */
    StdMinStdRandRandomNumberEngine(std::shared_ptr<RandomNumberEngineParameter<ResultType, EngineResultType>> param, std::shared_ptr<SeedGenerator<Seed>> seed)
