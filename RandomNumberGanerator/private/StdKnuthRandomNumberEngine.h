...
class StdKnuthRandomNumberEngine : public RandomNumberEngine<EngineResultType<StdKnuthRandomNumberEngine<Seed_>, Seed_>, Seed_>
{
    using Base = RandomNumberEngine<EngineResultType<StdKnuthRandomNumberEngine<Seed_>, Seed_>, Seed_>;

    using Engine = BaseEngine<StdKnuthRandomNumberEngine, Seed_>;
